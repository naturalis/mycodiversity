...
# A BLAST against the UNITE database is performed, minimal identity is 90%
blastn -query ${ZOTUS} -db ./deps/Unite/unite -outfmt '6 qseqid sseqid' -out ${OUTPUT} -perc_identity 90 -max_target_seqs 10
